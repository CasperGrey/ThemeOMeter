...
export function getSongsInTheme(id){
    return new Promise(function(resolve, reject){
        connection.query('SELECT f.* , ds.song_url ,ds.video_id from factentry f join dimsongs ds on f.song_id = ds.song_id where theme_id = ? and valid_entry = 1;', [id], function(err, rows, fields) {
